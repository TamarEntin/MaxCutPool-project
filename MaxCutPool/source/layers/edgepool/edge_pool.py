...
This specific implementation has been taken from
    `PyG PR #7746 <https://github.com/pyg-team/pytorch_geometric/pull/7746>`__ and is related to
    the paper `"Towards Reversible Graph Neural Networks: Decoding from Graph Embeddings"
    <https://www.esann.org/sites/default/files/proceedings/2022/ES2022-92.pdf>`__.
